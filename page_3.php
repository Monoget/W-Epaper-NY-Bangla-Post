...
<html>
<head>
    <title>ইমিগ্রেশনের আদ্যপান্ত - নিউইয়র্ক বাংলা পোস্ট ইপেপার</title>
...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="title-header clearfix">
            ...
            <h2 class="title-heading f-light">ইমিগ্রেশনের আদ্যপান্ত</h2>

        </div>
        <div class="seperator_15"></div>
        <a class="thumbnail imagethumb" target="_blank"
           href="paper_image/page_image/3.png"><img
                    src="paper_image/page_image/3.png"
                    alt=""/></a>
    </div>
    <div class="col-xs-3">
        <div class="seperator_15"></div>
