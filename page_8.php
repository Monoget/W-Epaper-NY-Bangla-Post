...
<html>
<head>
    <title>খেলার পাতা - নিউইয়র্ক বাংলা পোস্ট ইপেপার</title>
...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="title-header clearfix">
            ...
            <h2 class="title-heading f-light">খেলার পাতা</h2>

        </div>
        <div class="seperator_15"></div>
        <a class="thumbnail imagethumb" target="_blank"
           href="paper_image/page_image/8.png"><img
                    src="paper_image/page_image/8.png"
                    alt=""/></a>
    </div>
    <div class="col-xs-3">
        <div class="seperator_15"></div>
